function Question(question, answer1, answer2, answer3, answer4, rightAnswerIndex, ) {
  ...
  var question1 = new Question(" <a class = 'chums_question'>What is a perfect7777 example of a broadcast picture?</a>",
  ...
  "<img src='img/chums/q2/a.png'  class = 'choice-img' /><button  class='btn btn-danger btn-rounded guess0'>A</button> ", 
   ...
   "<img src='img/chums/q3/a.png'  class = 'choice-img' /> <button  class='btn btn-danger btn-rounded guess0'>A</button>ok<input type='checkbox' id='myCheck'  onclick='checkAnswer()'><p id='text' style='display:none'>Checkbox is CHECKED!</p>", 
    ...
    "<img src='img/chums/q3/d.png'  class = 'choice-img' /><button  class='btn btn-danger btn-rounded guess3 '>D</button>", 3);
     ...
     "<img src='img/chums/q4/a.png'  class = 'choice-img' /><button  class='btn btn-danger btn-rounded guess0 '>A</button> ", 
      ...
      "<img src='img/chums/q4/.png'   class = 'choice-img'/> <button  class='btn btn-danger btn-rounded guess3'>C</button>", );
